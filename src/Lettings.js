...
function Lettings({
  ...
  React.useEffect(() => {
    setNames([...names, ...lettingsTypes]);
    let newAll = {};
    for (let i = 0; i < lettingsTypes.length; ++i) {
      let copyFoo = {};
      copyFoo[lettingsTypes[i]] = i + 1;
  ...
  const searchLettings = () => {
    ...
    let axiosQuery =
      `https://api-beta.estateapps.co.uk/v2/property/residential/letting?
    ...
    <>
      <FormControl fullWidth style={{ margin: "10px" }}>
        ...
        >
          ...
          {lettingsLocations &&
            lettingsLocations.map(({ location, index }) => (
      ...
      <Button variant="contained" onClick={() => searchLettings()}>
        Search
      </Button>
